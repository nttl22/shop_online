    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="outer-w3-agile mt-3">
                <h4 class="tittle-w3-agileits mb-4">Địa chỉ giao hàng</h4>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT `order_id`, `lastname`, `name`, `address`, `phone`, `email` FROM `orderx` 
                            ...
                            if ($kq->num_rows > 0) {
                                ...
                                while ($row = $kq->fetch_assoc()) {
                                    ...
                                    echo '  <td>' . $row['lastname'] . ' ' . $row['name'] . '</td>';
            ...
            <div class="outer-w3-agile mt-3">
                <h4 class="tittle-w3-agileits mb-4">Chi tiết đơn hàng</h4>
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            if ($kq->num_rows > 0) {
                                ...
                                while ($row = $kq->fetch_assoc()) {
                                    ...
                                    echo '  <td>' . $row['qty'] . '</td>';
                                    echo '  <td>' . number_format($row['product_price']*$row['qty']) . ' VND</td>';
                                    echo '</tr>';
                                    $i++;
                                }
                            }
