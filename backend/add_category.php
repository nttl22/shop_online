...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($connect->query($sql)) {
        ...
        echo  "<script type='text/javascript'>alert('Đéo thêm được');</script>";
    }
}
?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <div class="form-head">Thêm danh mục</div>
                <div class="form-body">
                    <form action="add_category.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea style="resize: none;" name="category_desc" rows="5" class="form-control"></textarea>
                        </div>
