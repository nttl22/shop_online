<?php
include 'connect.php';
$sql = "SELECT * FROM category WHERE category_id=" . $_GET['categoryid'] . "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE category SET category_name='$category_name', category_desc='$category_desc' WHERE category_id=$id";
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <div class="form-head">Sửa danh mục</div>
                <div class="form-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea style="resize: none;" name="category_desc" rows="5" class="form-control"><?php echo $row['category_desc'] ?></textarea>
                        </div>
