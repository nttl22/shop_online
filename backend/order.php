    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="outer-w3-agile mt-3">
                <h4 class="tittle-w3-agileits mb-4">Danh sách đơn hàng</h4>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            include 'connect.php';
                            $sql = "SELECT `order_id`, user.username , `user_id`, `date` FROM `orderx`, `user` 
                                        WHERE orderx.user_id=user.userid";
                            ...
                            if ($kq->num_rows > 0) {
                                ...
                                while ($row = $kq->fetch_assoc()) {
                                    ...
                                    echo '  <td>' . $row['date'] . '</td>';
                                    echo '  <td>';
                                    echo '      <a class="idelete" href="order_detail.php?orderid=' . $row['order_id'] . '"><i class="fas fa-info-circle"></i></a>';
                                    echo '  </td>';
                                    echo '</tr>';
                                    $i++;
                                }
